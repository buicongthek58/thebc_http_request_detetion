...
# os.environ["CUDA_VISIBLE_DEVICES"] = "FASTEST_FIRST"
...
class Trainer():
    ...
    def train(self, model, train_data, train_size, num_steps, num_epochs, min_loss=0.3):
        ...
        with tf.Session() as sess:
            ...
            try:
                saver.restore(sess, tf.train.latest_checkpoint(self.checkpoints))
            ...
            for step in range(1, num_steps):
                ...
                fetches = [merge, model.loss, model.decoder_outputs, model.train_optimizer]
